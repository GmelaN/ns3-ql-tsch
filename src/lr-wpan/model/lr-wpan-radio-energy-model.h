...
class LrWpanRadioEnergyModel : public DeviceEnergyModel
{
  ...
  public:
     ...
     */
    PhyEnumeration GetCurrentState(void) const;
     ...
     */
    void ChangeLrWpanState(Time t, PhyEnumeration oldstate, PhyEnumeration newstate);
  ...
  private:
     ...
     */
    void SetLrWpanRadioState(const PhyEnumeration state);
  ...
  private:
    ...
    // State variables.
    PhyEnumeration m_currentState;   // current state the radio is in
    Time m_lastUpdateTime;           // time stamp of previous energy update
    double m_energyToDecrease;       // consumed energy of lastest LrWpanRadioEnergyMode
    double m_remainingBatteryEnergy; // remaining battery energy of the energy source attaching to
                                     // the node
    bool m_sourceEnergyUnlimited;    // battery energy of the energy source attaching to the node
                                     // unlimited or not
